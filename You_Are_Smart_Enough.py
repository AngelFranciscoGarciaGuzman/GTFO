...
print("Pregunta 3: Cuánto es", lista_random[0], "+ ", lista_random[1], "?")
respuesta2 = int(input())

if respuesta2 == (suma(lista_random[0], lista_random[1])):
    print("Correcto!")
    puntos = puntos + 1
    print("Tienes ", puntos, "puntos")
else:
...
if respuesta3 == (lista_random[2]):
    print("Correcto!")
    puntos = puntos + 1
    print("Tienes ", puntos, "puntos")
else:
    print("Incorrecto, yo estaba pensando en:", lista_random[2])
    print("Tienes ", puntos, "puntos")
...
print(
    "Redondo soy y es cosa anunciada, si a la derecha estoy algo valgo pero si a la izquierda estoy no valgo nada. Qué numero soy?")
...
if resultado_dados == True:
    print("Ganaste el duelo con una puntuación de: ", dado_jugador + d5, "Mientas que la computadora obtuvo: ",
          dado_computadora)
else:
    print("Haz perdido el duelo con una puntuación de:", dado_jugador + d5, "Mientras que la computadora obtuvo:",
          dado_computadora)
    print("Tu computadora se autodestruirá en:")
    countdown(10)
    exit()
...
def castigo():
    ...
    while num_castigo != lista_random[3]:
        num_castigo = int(input())
        contador = contador + 1
    if num_castigo == lista_random[3]:
